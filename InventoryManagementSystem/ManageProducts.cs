    ...
    public partial class ManageProducts : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("Product Successfully Added", "Added", MessageBoxButtons.OK, MessageBoxIcon.Information);
                Con.Close();
                populate();
            }
            catch
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("Product Successfully Deleted", "Deleted",MessageBoxButtons.OK,MessageBoxIcon.Warning);
                Con.Close();
                populate();
            }
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("Product Successfully Updated", "Updated", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                Con.Close();
                populate();
            }
            catch
